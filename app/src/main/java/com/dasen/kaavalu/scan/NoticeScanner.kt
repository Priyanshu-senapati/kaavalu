...
object NoticeMarkers {
    ...
    val MARKERS = listOf(
        ...
        Marker(
            "arrest",
            r(
                """arrest warrant|warrant of arrest|non[- ]?bailable|bailable warrant""" +
                    """|liable to be arrested|will be arrested|taken into custody|issued against you""" +
        ...
        Marker(
            "crime-story",
            r(
                """money laundering|pmla|ndps|narcotics|\bdrugs?\b|contraband|psychotropic""" +
        ...
        Marker(
            "agency",
            r(
                """\bcbi\b|central bureau of investigation|enforcement directorate|\bncb\b""" +
